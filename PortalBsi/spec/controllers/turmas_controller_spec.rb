  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved turma as @turma" do
        ...
        post :create, {:turma => { "nome" => "invalid value" }}, valid_session
        assigns(:turma).should be_a_new(Turma)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested turma" do
        ...
        Turma.any_instance.should_receive(:update).with({ "nome" => "MyString" })
        put :update, {:id => turma.to_param, :turma => { "nome" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the turma as @turma" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Turma.any_instance.stub(:save).and_return(false)
        put :update, {:id => turma.to_param, :turma => { "nome" => "invalid value" }}, valid_session
        assigns(:turma).should eq(turma)
      end
