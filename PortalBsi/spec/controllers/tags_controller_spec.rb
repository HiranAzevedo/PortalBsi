  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tag as @tag" do
        ...
        post :create, {:tag => { "nome" => "invalid value" }}, valid_session
        assigns(:tag).should be_a_new(Tag)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tag" do
        ...
        Tag.any_instance.should_receive(:update).with({ "nome" => "MyString" })
        put :update, {:id => tag.to_param, :tag => { "nome" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tag as @tag" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tag.any_instance.stub(:save).and_return(false)
        put :update, {:id => tag.to_param, :tag => { "nome" => "invalid value" }}, valid_session
        assigns(:tag).should eq(tag)
      end
