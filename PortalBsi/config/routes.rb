Rails.application.routes.draw do
  ...
  match '/tccs/:id/desfaz_publicado', to: 'tccs#desfaz_publicado', via: 'get', as:  'tccs_desfaz_publicado'
  match '/tccs/:id/confirma_desfaz_publicado', to: 'tccs#desfaz_publicado', via: 'patch', as: 'tccs_confirma_desfaz_publicado'
