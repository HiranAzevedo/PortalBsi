function Clock() {
	this.z = 1000000000000000000; //deve ser o último a interagir
	this.weeks = 16;
	this.days = 0;
	this.hours = 0;
	//this.lastWeek = 16;
	...
	this.isTimeout = function() {
		return (this.weeks>=this.lastWeek); //é preciso interromper apenas na próxima interação para que seja apresentado na tela o valor da última semana
	}
